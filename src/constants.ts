 ...
 */
export const FORCE_GROUPBY = "$$_ForceGroupBy";

/**
 * Suffix for specifying aggregate functions in a ReportQuery. Value is "_AggFunc".
 */
export const AGGFUNC = "_AggFunc";

/**
 * Suffix for specifying comma-separated list of aggregated currency fields for the report
 */
export const AGGCURRENCY_FIELDS = "$$AggCurr";
export const GROUPCURRENCY_FIELDS = "$$GroupCurr";


export const SORTCURRENCY_FIELDS = "$$SortCurr";
export const FILTERCURRENCY_FIELDS = "$$FilterCurr";
